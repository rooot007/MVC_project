           ...
           <!--  <div class="container-fluid">     -->
                <!-- <div class="row card"> -->
                        <div class="bs-callout bs-callout-warning">
                              <h4>Оставить сообщение могут только зарегистрированные пользователи.</h4>
                              <p class="bg-warning">Пожалуйста, зарегистрируйтесь и войдите для возможности отправки сообщения.<br/> Данная процедура не займет более 1 минуты.</p>
                        </div>
                <!-- </div> -->
        </div>         
